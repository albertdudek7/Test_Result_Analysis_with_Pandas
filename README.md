...
I was able to get help from a very helpful tutor named Tristan Oritz through Ask BCS, he helped me to display the correct format for the per_school_summary table.

I also was able to use some helpful hints and code from classmates that posted in Slack including Kirsten Rain and Aaron Otto in regards to the Per School Spending Tables.

I used some pointers from chapgpt as well to help with formatting for getting per_school_summary started. 
